  ...
  <v-menu offset-y>
    <template v-slot:activator="{ on, attrs }">
      <v-btn v-bind="attrs" v-on="on" text>
        <v-avatar size="32px">
          <img
        src="https://scontent.fbkk12-1.fna.fbcdn.net/v/t39.30808-6/358140223_2012375742436021_3893854973203067204_n.jpg?_nc_cat=106&ccb=1-7&_nc_sid=a5f93a&_nc_eui2=AeFQpV2ZJ7w8Z0JiXYB5PVw0eM7c5tAKTMx4ztzm0ApMzI6-0pTN0CEa6PA6SH6tRFNJP8Yv76P-Sz1ay9VSp5yI&_nc_ohc=SP6zRfzjYLAQ7kNvgGYJL0E&_nc_ht=scontent.fbkk12-1.fna&oh=00_AYDps2d97FYl4XJ9Mog3uuPndgfFe38N7GRKCg8dvlBfpQ&oe=66A5AC4A"
        alt="kim"
      >
        </v-avatar>
...
export default {
  data() {
    return {
      ...
      packages_type:'',
      filter:[],
      IP: "https://c4bf-2403-6200-88a4-6aa7-4168-73c4-7cef-f2c0.ngrok-free.app"
    };
  },
  mounted() {
    this.fetchPackages();
